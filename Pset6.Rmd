---
title: 'Ling 104 Problem Set 6: Case systems'
...
Report the following (by printing tables using Tidyverse):
...
Find the mean and median of the L1.Estimate column. Which is higher: the mean or median? Why is this the case?
...
First, make a scatter plot of LogL1 vs. LogL2. Do this in ggplot().
...
Now, compute the mean of Case.Rank separately for each Language Family (which is called Stock in the data set). Use that as a prediction. Then, compute the sum of the squared error and compare it to the value you found for Q9. 
...
# 18. Using the answers to the preceding, discuss which variable (among LogL1, LogL2, Percent.L2) best predicts Case.Rank.
