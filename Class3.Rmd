...
Now plot the relationship between LengthInLetters and the mean RTms. Use facet_grid() [Google or use the question mark] to create separate facets for WordCategory. 
